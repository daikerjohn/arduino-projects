...
#define TRACE
//#include <Arduino.h>
#include <NimBLEDevice.h> // NimBLE-Arduino - h2zero - 2.3.7
...
/*
  ...
  */
  ...
  WOL.setBroadcastAddress(IPAddress(192, 168, 30, 255));
}
